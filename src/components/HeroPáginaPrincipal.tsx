...
import { CarroselUsuários } from "./CarroselUsuários";

export function HeroPáginaPrincipal() {

    return (
        <section className="w-full h-[100vh] mx-auto flex flex-col items-center justify-center gap-y-[20px]  overflow-hidden">
            <div className="flex flex-col gap-y-[20px] ">
                <div className="flex flex-col items-center gap-2 gap-y-[25px] text-center w-full max-w-[852px]">
                    <h1 data-aos="fade-up" className="text-[3.5rem] sm:text-[5rem] tracking-tight text-white font-semibold leading-[3.75rem] sm:leading-[5rem]">Tudo que você precisa para viver do digital.</h1>
