...
export default function PáginaDoFinanceiro() {
    return (
        <div className="bg-white dark:bg-neutral-950 flex flex-col w-full">
          ...
          <button className="bg-white dark:bg-neutral-950 group cursor-pointer hover:bg-blue-50 rounded-2xl sm:rounded-3xl w-[390px] p-3 sm:px-4 sm:py-4 flex items-start justify-between border border-blue-200 dark:border-white/30 hover:border-blue-300 dark:hover:bg-white/5">
              ...
              <div className="bg-blue-500 border border-blue-400 dark:bg-transparent text-white dark:border-white/50 w-[60px] h-[60px] sm:w-[55px] sm:h-[55px] rounded-xl sm:rounded-2xl flex items-center justify-center ">
