...
export const metadata: Metadata = {
    title: 'Crie sua conta para conitnuar - Gateway',
                ...
                <div className="flex flex-col items-center gap-y-[15px] justify-center w-full max-w-md">
                    <div className="flex items-start flex-col w-full">
                        <div className="flex flex-col py-5">
                            <h1 className="text-[2.75rem] leading-[2.5rem] text-white font-medium ">Bem-vindo a Gateway. Crie uma conta para continuar.</h1>
                        </div>
                    ...
                    <div className="abolsute bottom-0 flex items-start w-full">
                        <p className="text-sm text-center text-white/60">Ao criar a conta você concorda com nossos{""} <Link href="/terms/service" className="hover:underline hover:underline-offset-4">Termos de Serviço</Link> {""} e {""} <Link href="/terms/privacy" className="hover:underline hover:underline-offset-4">Políticas de Privacidade</Link>.</p>
                    </div>
                </div>
            </section>
